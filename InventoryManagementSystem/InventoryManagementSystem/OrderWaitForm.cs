...
{
    public partial class OrderWaitForm : Form
    {
        ...
        private void dgvOrder_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Delete")
            {
                if (MessageBox.Show("Are you sure you want to delete this activity?", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.Parameters.AddWithValue("@loginfo", ("Admin  \" " + LoginForm.adminfullname.ToString() + "\"  has been DELETED the WAITING FOR APPROVAL Client  \" " + dgvOrder.Rows[e.RowIndex].Cells[6].Value.ToString() + "\"  request with Activity ID #" + dgvOrder.Rows[e.RowIndex].Cells[1].Value.ToString()));
            ...
            {
                DialogResult result = MessageBox.Show("Do you Want to Approve this Activity?", "Approve Activity", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Activity has been Approved!");




                    cm = new SqlCommand("INSERT INTO tblog(loginfo, logdate)VALUES(@loginfo, @logdate)", con);
                    cm.Parameters.AddWithValue("@loginfo", ("Admin  \" " + LoginForm.adminfullname.ToString() + "\"  has been APPROVED Client  \" " + dgvOrder.Rows[e.RowIndex].Cells[6].Value.ToString() + "\"  request with Activity ID #" + dgvOrder.Rows[e.RowIndex].Cells[1].Value.ToString()));
                    cm.Parameters.AddWithValue("@logdate", DateTime.Now);
                    con.Open();
                    cm.ExecuteNonQuery();
                    con.Close();
                    ...
                    cm.Parameters.AddWithValue("@usercid", dgvOrder.Rows[e.RowIndex].Cells[5].Value.ToString());
                    cm.Parameters.AddWithValue("@userloginfo", ("Your request has been APPROVED with Activity ID #" + dgvOrder.Rows[e.RowIndex].Cells[1].Value.ToString()));
                ...
                else if (result == DialogResult.No)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Activity has been Not Approved!");
                    ...
                    cm = new SqlCommand("INSERT INTO tblog(loginfo, logdate)VALUES(@loginfo, @logdate)", con);
                    cm.Parameters.AddWithValue("@loginfo", ("Admin  \" " + LoginForm.adminfullname.ToString() + "\"  has been REJECTED Client  \" " + dgvOrder.Rows[e.RowIndex].Cells[6].Value.ToString() + "\"  request with Activity ID #" + dgvOrder.Rows[e.RowIndex].Cells[1].Value.ToString()));
                    cm.Parameters.AddWithValue("@logdate", DateTime.Now);
                    con.Open();
                    cm.ExecuteNonQuery();
                    con.Close();
                    ...
                    cm = new SqlCommand("INSERT INTO tbUserlog(usercid, userloginfo, userlogdate)VALUES(@usercid, @userloginfo, @userlogdate)", con);
                    cm.Parameters.AddWithValue("@usercid", dgvOrder.Rows[e.RowIndex].Cells[5].Value.ToString());
                    cm.Parameters.AddWithValue("@userloginfo", ("Your request has been REJECTED with Activity ID #" + dgvOrder.Rows[e.RowIndex].Cells[1].Value.ToString()));
                    cm.Parameters.AddWithValue("@userlogdate", DateTime.Now);
                    con.Open();
                    cm.ExecuteNonQuery();
                    con.Close();
