...
{
    public partial class UserOrderExpiredModuleForm : Form
    {
        ...
        public UserOrderExpiredModuleForm()
        {
            InitializeComponent();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Are you sure you want to Extend Time?", "Extend Time", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.Parameters.AddWithValue("@loginfo", ("NOTE: Client  \"" + UserLoginForm.CName.ToString() + " \"  requested to EXTEND TIME from " + txtReturnOrder.Text + " to " + dtExtendOrder.Text + ". Please Check the Waiting List for Approval"));
